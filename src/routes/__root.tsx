  ...
  createRootRouteWithContext<{
    ...
    head: () => ({
      meta: [
        ...
        {
          title:
            "ShopGraph — Discover products through connections",
        },

        {
          name: "description",
          content:
            "ShopGraph recommends products through relationships between people, products, brands and categories.",
        },
...

        {
          ...
          content:
            "Explainable product recommendations built on relationships.",
        },
